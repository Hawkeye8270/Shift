...
• Версия Java - 17 Eclipse Temurin version 17.0.13;  
• Система сборки - Maven version 3.8.1;  

Для запуска в командной строке необходимо указать:  
  1. Выбор статистики (-s или -f);
  2. По умолчанию файлы результатов перезаписываются. С помощью опции -a можно задать
     режим добавления в существующие файлы;
  3. С помощью опции -р можно задать префикс имен выходных файлов;
  4. Задать путь к исходным файлам;

Пример: -s -a -p sample- D:\Temp\in1.txt D:\Temp\in2.txt
